...
#define FIX_MATH_FRACTIONAL_BIT_COUNT 6
#endif
...
static const fixed_t fix_maximum  = 0x7FFFFFFF;
static const fixed_t fix_minimum  = 0x80000000;
static const fixed_t fix_one = 1 << FIX_MATH_FRACTIONAL_BIT_COUNT;
static const fixed_t fix_pi = 0x0003243F >> FIX_MATH_FRACTIONAL_OFFSET;
static const fixed_t fix_pi_div_2 = 0x00019220 >> FIX_MATH_FRACTIONAL_OFFSET;
static const fixed_t PI_DIV_4 = 0x0000C910 >> FIX_MATH_FRACTIONAL_OFFSET;
static const fixed_t THREE_PI_DIV_4 = 0x00025B30 >> FIX_MATH_FRACTIONAL_OFFSET;
